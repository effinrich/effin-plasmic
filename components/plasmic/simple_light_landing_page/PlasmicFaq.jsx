...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: edztDi8y5MdWn7/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__thVwk)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__vj7Hz)}>
          <div className={classNames(projectcss.all, sty.freeBox___1CzTh)}>
            {p.renderPlasmicSlot({
